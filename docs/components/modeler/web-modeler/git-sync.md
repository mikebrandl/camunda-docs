...
3. Fill in the **Configure Bitbucket** modal with the following information:
   ...
   - **Bitbucket repository URL:** The base URL of the repository you want to sync with, e.g., `https://bitbucket.org/camunda-workspace/my-repository`. The URL must not include the `.git` extension or any folder path.
   - **Branch name:** The branch to use for merging and managing changes.
